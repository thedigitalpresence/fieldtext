...
export default async function DashboardPage({ searchParams }: { searchParams?: { imported?: string; cityerr?: string } }) {
  ...
  const labels = {
    ...
    reminders: d.reminders, none: d.none, markAccepted: d.markAccepted, markDeclined: d.markDeclined,
    removeClient: d.removeClient, confirmRemove: d.confirmRemove, addNote: d.addNote,
