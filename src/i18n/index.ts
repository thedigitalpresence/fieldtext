...
const en = {
  ...
  markDeclined: "Declined / remove",
  removeClient: "Remove",
  confirmRemove: "Remove this client? They'll come off your list.",
  addNote: "Add note",
...
const es: Dict = {
  ...
  none: "Ninguno",
  markAccepted: "Aceptado",
  markDeclined: "Rechazado / quitar",
  removeClient: "Quitar",
  confirmRemove: "¿Quitar este cliente? Saldrá de tu lista.",
